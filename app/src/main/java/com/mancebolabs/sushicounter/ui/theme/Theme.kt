...
/** Applies app theme and floating-nav insets for Compose Previews. */
@Composable
fun ItamaePreviewTheme(
    darkTheme: Boolean = false,
    content: @Composable () -> Unit,
) {
    CompositionLocalProvider(
        LocalFloatingNavBarHeight provides ItamaeSpacing.floatingNavBarDefaultHeight,
    ) {
        SushiCounterTheme(darkTheme = darkTheme, content = content)
    }
}
